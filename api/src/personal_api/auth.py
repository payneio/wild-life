...
Each accepted token resolves to an :class:`~personal_api.identity.Identity` via the
in-memory :data:`~personal_api.identity.registry`; the identity is attached to
...
from personal_api.identity import TokenRegistry, worker_write_allowed
