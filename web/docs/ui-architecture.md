...
**One deliberate exception** (intentional, not gaps): **Person** is a relationship-rich
...
the `people` lookup (`mentions.ts` notes this). A bespoke object still belongs to the object
